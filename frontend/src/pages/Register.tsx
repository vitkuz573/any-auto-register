      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1.45fr)_340px]">
        <div className="space-y-4">
              ...
              {form.identity_provider === 'oauth_browser' && (
                <>
                  ...
                  <p className="text-xs text-[var(--text-muted)]">
                    When using headless browser automation for third-party accounts, it is recommended to configure Chrome Profile or Chrome CDP first to reuse the local logged-in browser session.
                  </p>
                </>
              )}
            </CardContent>
          ...
          {form.identity_provider === 'mailbox' && (
            <Card>
              <CardHeader><CardTitle>System Mailbox Configuration</CardTitle></CardHeader>
              <CardContent className="space-y-4">
                {optionsError && (
                ...
                {mailboxProviderOptions.length > 0 ? (
                  ...
                  <div className="rounded-2xl border border-amber-500/20 bg-amber-500/10 px-4 py-3 text-sm text-amber-200">
                    No enabled mailbox provider currently. Please go to Settings to add and enable a default mailbox provider first.
                  </div>
                )}
          ...
          {smsProviderOptions.length > 0 && (
            <Card>
              <CardHeader><CardTitle>SMS Code Configuration</CardTitle></CardHeader>
              <CardContent className="space-y-4">
                {optionsError && (
                  <div className="rounded-2xl border border-red-500/20 bg-red-500/10 px-4 py-3 text-sm text-red-300">
                    {optionsError}
        ...
        <div className="space-y-5 xl:sticky xl:top-4 xl:self-start">
          ...
          {task ? (
            <>
              ...
              <Card>
                <CardHeader><CardTitle>Real-time Logs</CardTitle></CardHeader>
                <CardContent>
            ...
            <Card className="bg-[var(--bg-pane)]/55">
              <CardHeader><CardTitle>Waiting to Execute</CardTitle></CardHeader>
              <CardContent className="text-sm text-[var(--text-secondary)]">Status and logs will be displayed after creation.</CardContent>
            </Card>
          )}
        </div>
      </div>
