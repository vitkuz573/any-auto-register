...
const CATEGORY_GROUPS = [
  { key: 'free', label: 'Free / Ready to use', desc: 'No self-hosted service required, use directly' },
  { key: 'selfhost', label: 'Self-hosted required', desc: 'Requires deploying your own backend service' },
  { key: 'thirdparty', label: 'Third-party service', desc: 'Requires registering on a third-party platform to obtain credentials' },
